...
export default Ember.View.extend({
    ...
    var view=this;
    $("#upload_records_form").fileupload({
      dataType:"json",
    ...
    $("#upload_records_inserts_form").fileupload({
      dataType:"json",
      done:function(e,data){
        alert("success")
        console.log(data)
    ...
    $("#upload_transactions_inserts_form").fileupload({
      dataType:"json",
      done:function(e,data){
        alert("success")
        console.log(data)
    ...
    $("#upload_transactions_experimental_form").fileupload({
      dataType:"json",
      done:function(e,data){
        alert("success")
        console.log(data)
